...
const KeyFeatures = () => {
 ...
 mb-4 w-2xl"
          ...
          <button
            className="bg-green-700 hover:bg-green-800 text-white px-7 py-3  rounded-lg  font-medium w-full md:w-auto
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 mt-16 gap-6">
        {features.map((feature, idx) => (
          ...
          >
            ...
            <p className="text-gray-600 font-sans max-w-60 mt-3 ml-10">
              {feature.desc}
            </p>
          </div>
        ))}
