...
const Collaborate = () => {
  return (
    <section className="py-20 px-4 bg-[linear-gradient(180deg,rgba(144,222,120,0.15)_0%,rgba(187,249,168,0.15)_100%)] text-center rounded-2xl mx-4 md:mx-12 lg:mx-36">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-32 text-center lg:text-left">
        {/* Heading */}
