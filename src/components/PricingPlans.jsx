  ...
  return (
    <section className="py-16 px-4 sm:px-10 md:px-16 lg:px-20 bg-white">
      ...
      <div className="text-center mb-10">
        ...
        <p
          className="text-[#6D6D6D] font-sans
 mt-2 text-sm md:text-base"
      ...
      <div className="flex justify-center mb-12">
        <div className="inline-flex bg-gray-200 rounded-full p-1 w-full sm:w-auto max-w-xs sm:max-w-none mx-auto">
          <button className="w-1/2 sm:w-auto px-4 py-1 rounded-full text-sm font-semibold text-gray-600 hover:bg-white hover:text-black transition">
            Monthly billing
          </button>
          <button className="w-1/2 sm:w-auto px-4 py-3 rounded-full text-sm font-semibold text-gray-600 hover:bg-white hover:text-black transition">
            Annual billing
          </button>
        </div>
      </div>
      ...
      {/* Pricing Cards */}
      <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-[46px] max-w-[1142px] mx-auto mb-16 ">
        {/* Starter */}
        <div className="rounded-xl shadow-sm border border-gray-200 p-6 flex flex-col h-[471px] w-[350px]">
          <div className="flex-1">
            <div className="text-center mb-4">
              <span className="text-xs font-light text-green-700 bg-[rgba(49,123,34,0.1)] px-3 py-1 rounded-full uppercase">
                STARTER
              </span>
            </div>
        ...
        <div className="rounded-xl shadow-sm border border-gray-200 p-6 flex flex-col h-[471px] w-[350px]">
          ...
          <button className=" text-sm font-medium px-4 py-3 rounded-md w-full bg-[#317B22] text-white hover:bg-green-700">
            Get started for free
          </button>
        </div>
